...
class AlphabetDetector {
  ...
  /**
   * Detecta el alfabeto de entrada Σ desde una cadena.
   * Ignora espacios y el símbolo blanco 'B'.
   * 
   * @param {string} input
   * @returns {string[]}
   */
  static detectInputAlphabet(input) {
  ...
  /**
   * Construir el alfabeto de cinta Γ
   * Γ = Σ ∪ {B} ∪ auxiliares
   * 
   * @param {string[]} inputAlphabet
   * @param {string[]} auxiliarySymbols
   * @returns {string[]}
   */
